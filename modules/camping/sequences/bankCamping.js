...
foo.instructions = [
	...
	{"@listen": 					["goToTargetLogs", "cleanMyIpClues", "extractDataFromLog", {"jumpif":["((*.accounts.length > 0) || (*.myCluesFound))", "@submitLogChanges"]}, {"wait": 4000}, {"jumpif":["true", "@listen"]}]},
	...
	{"@transferMoney": 				["isThereMessageError", {"jumpif":["*.$", "@startAccountAtack"]}, "checkFunds", {"jumpif": ["!*.$", "@cleanTransferLogs"]}, {"wait": 3000}, "transferMoneyToTarget", "sendMoneyToBTCWallet"]},
