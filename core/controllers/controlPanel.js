			...
			if(this.checked){
				...
				switch(this.id){
					case SET_LOGS_MONITOR:
						...
						console.log("HwBot: Logs monitor is stopped")
						break
					case SET_MISSIONS_MONITOR:
						$jSpaghetti.module("monitor").sequence("checkMission").reset()
						console.log("HwBot: Missions monitor id stopped")
						break
					default: break
				}
			}
